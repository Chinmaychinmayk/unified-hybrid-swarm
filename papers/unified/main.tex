...
\author{I~Harihara~Sudar,
        ...
        Chinmay~K,
        Rishi~Charan,
        Laxmi~Narayana~Charan,
        and~Mervin~Joe~Thomas%
...
\begin{figure}[!t]
\centering
\subfloat[Front view]{\includegraphics[width=0.52\columnwidth]{fig02a_front.png}}
\hfil
\subfloat[Top view]{\includegraphics[width=0.40\columnwidth]{fig02b_top.png}}
...
\begin{figure}[!t]
\centering
\subfloat[Charging schematic]{\includegraphics[width=0.56\columnwidth]{bs_circuit.png}}
\hfil
\subfloat[Fabricated landing pad]{\includegraphics[width=0.40\columnwidth]{landing_pad.png}}
...
\begin{figure}[!t]
\centering
\subfloat[Raspberry Pi enclosure]{\includegraphics[width=0.40\columnwidth]{fig06a_pi_iso.png}}
\hfil
\subfloat[Camera/gimbal mount]{\includegraphics[width=0.50\columnwidth]{fig09_cam.png}}\\
\subfloat[2D LiDAR mount]{\includegraphics[width=0.40\columnwidth]{fig10_lidar2d.png}}
\hfil
\subfloat[Propeller guards]{\includegraphics[width=0.50\columnwidth]{fig11_propguard.png}}
...
\begin{figure}[!t]
\centering
\subfloat[Visual centering on the base station]{\includegraphics[width=0.50\columnwidth]{fig16_center.png}}
\hfil
\subfloat[2D-LiDAR view during centering]{\includegraphics[width=0.40\columnwidth]{fig17_lidarcenter.png}}
...
\begin{figure}[t]
\centering
\subfloat[Mid-field hexagon school.]{\includegraphics[width=0.49\columnwidth]{swarm_rviz_midfield.png}}
\hfil
\subfloat[All seven executed paths.]{\includegraphics[width=0.49\columnwidth]{swarm_rviz_paths.png}}
...
\begin{figure}[t]
\centering
\subfloat[Executed fish-school trajectories]{\includegraphics[width=0.49\columnwidth]{fish_swarm_traj.png}}
\hfil
\subfloat[RViz fish-school capture]{\includegraphics[width=0.49\columnwidth]{fish_swarm_rviz.png}}
